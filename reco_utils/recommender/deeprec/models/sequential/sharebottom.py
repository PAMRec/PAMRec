...
__all__ = ["ShareBottomModel"]


class ShareBottomModel(SequentialBaseModel):
    ...
    def _build_train_opt(self):
        ...
        return super(ShareBottomModel, self)._build_train_opt()


    def _build_embedding(self):
        """The field embedding layer. Initialization of embedding variables."""
        super(ShareBottomModel, self)._build_embedding()
    ...
    def _lookup_from_embedding(self):
        ...
        """
        super(ShareBottomModel, self)._lookup_from_embedding()
    ...
    def _build_seq_graph(self):
        ...
        with tf.variable_scope("clsr"):
            ...
            model_output = tf.concat([self.att_fea_long, self.att_fea_short, self.target_item_embedding], 1)
            self.valid_output = tf.concat([self.att_fea_long, self.att_fea_short, self.target_item_embedding], 1)
